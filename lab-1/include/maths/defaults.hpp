...
template <typename T>
static constexpr size_t DEFAULT_TERMS = 30;

template <>
static constexpr size_t DEFAULT_TERMS<float> = 30;

template <>
static constexpr size_t DEFAULT_TERMS<double> = 50;

template <>
static constexpr size_t DEFAULT_TERMS<long double> = 70;
